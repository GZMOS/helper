...
[`helper-contract/IPC_CONTRACT.md`](https://github.com/wispr-flow-linux/wispr-flow-linux/blob/master/helper-contract/IPC_CONTRACT.md)
...
(IPC_CONTRACT.md §8). Add a `'linux'` branch pointing at this binary, staged
...
[`LINUX_PORT_ANALYSIS.md`](https://github.com/wispr-flow-linux/wispr-flow-linux/blob/master/LINUX_PORT_ANALYSIS.md)
"Legal note" in the main repo.
